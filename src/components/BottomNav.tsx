...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#1a1a2e] md:hidden justify-between flex items-center rounded-full mx-4 mb-6 shadow-lg border border-[#2c2c3a]">
