...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#1a1a2e] md:hidden justify-between min-h-[50px] flex items-center rounded-t-full shadow-lg border border-[#2c2c3a]">
